...
--通过过滤条件降序显示前5条记录
SELECT ZWID,ZWNAME,ZWMONEY FROM gjp_zhangwu WHERE ZWID<10 ORDER BY ZWMONEY DESC LIMIT 5;
--通过过滤条件!=降序显示前5条记录
SELECT * FROM gjp_zhangwu WHERE ZWNAME <> '股票收入' ORDER BY ZWMONEY DESC LIMIT 0,5;
